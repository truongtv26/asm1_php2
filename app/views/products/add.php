            ...
            <div class="card-body">
                ...
                <form class="row g-3" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="price" class="form-control" id="inputEmail" value="<?=$dataFields['price'] ?? ''?>">
                        <span class="text-danger fs-8"><?=$errors['price'] ?? ''?></span>
                    </div>
                    <div class="col-12">
                        <label for="inputPassword4" class="form-label">Số lượng</label>
                        <input type="text" name="quantity" class="form-control" id="inputPassword" value="<?=$dataFields['quantity'] ?? ''?>">
                        <span class="text-danger fs-8"><?=$errors['quantity'] ?? ''?></span>
                    </div>
                    <div class="col-12">
                        <label for="inputAddress" class="form-label">Mô tả</label>
                        <input type="text" name="description" class="form-control" placeholder="" value="<?=$dataFields['desciption'] ?? ''?>">
